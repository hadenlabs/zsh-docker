<!-- Space: ZshDocker -->
<!-- Parent: Project -->
<!-- Title: Contributing GitFlow ZshDocker -->
...
To contribute to zsh-docker project on [GitHub](https://github.com/hadenlabs/zsh-docker), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-docker/pulls).
